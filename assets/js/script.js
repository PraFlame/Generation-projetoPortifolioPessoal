...
async function getProjectsGithub() {
    try {
        //Não esqueça de trocar conteúdoGeneration pelo seu usuário do GitHub
        const resposta = await fetch('https://api.github.com/users/PraFlame/repos?sort=updated&per_page=6');
        ...
        repositorios.forEach(repositorio => {
            ...
            //Constrói a URL que aponta para o logo da Linguagem padrão do repositorio
